...
export const archive = [
  {
    ...
    key: "agentic",
    rows: [
      { title: "Evidence as an interface primitive", org: "Lolo", year: "2025–now", href: "/work/lolo.html", note: "Provenance inside the sentence, not in a drawer" },
      { title: "Change management review queue", org: "Lolo", year: "2025–now", href: "/work/lolo.html", note: "Agents propose, advisors dispose" },
      { title: "Meeting-to-workflow ingestion", org: "Lolo", year: "2025–now", href: "/work/lolo.html", note: "Transcript as the front door" },
      { title: "Generative component library", org: "Bonsai", year: "2025", href: "/work/bonsai.html", note: "Make the invalid combination impossible to produce" },
      { title: "Embedded search frontend v1", org: "Bonsai", year: "2025", href: "/work/bonsai.html", note: "Streaming, partial states, no layout shift" },
      { title: "Document change propagation", org: "Sygma", year: "2024–25", href: "/work/sygma.html", note: "What breaks, and who needs to know today" },
      { title: "Scheduling scout agent", org: "Sygma", year: "2024–25", href: "/work/sygma.html", note: "Finds the conflict, human moves the date" },
    ],
  },
  {
    ...
    key: "operations",
    rows: [
      { title: "KDS item times", org: "Fresh", year: "2025–now", href: "/work/fresh.html", note: "Ticket → item as the unit of truth" },
      { title: "Automations", org: "Fresh", year: "2025–now", href: "/work/fresh.html", note: "Operator-authored rules layer" },
      { title: "Enterprise configurability", org: "Fresh", year: "2025–now", href: "/work/fresh.html", note: "Three months of build; won 7-Eleven" },
      { title: "Signup conversion programme", org: "Fresh", year: "2025–now", href: "/work/fresh.html", note: "+40%, mostly from the worst-converting segments" },
      { title: "Web configuration app", org: "Fresh", year: "2025–now", href: "/work/fresh.html", note: "Multi-site routing without touching devices" },
      { title: "Device fleet management", org: "Fresh", year: "2025–now", href: "/work/fresh.html", note: "Support-call volume as a design metric" },
      { title: "Fleet software management", org: "Viasat", year: "2023–25", href: "/work/viasat.html", note: "Rollout staged to maintenance windows" },
      { title: "Resolution system", org: "Viasat", year: "2023–25", href: "/work/viasat.html", note: "Ordered by what is achievable before wheels-up" },
      { title: "Error identification ML", org: "Viasat", year: "2023–25", href: "/work/viasat.html", note: "Forty tickets → one pattern with a fix" },
    ],
  },
  {
    ...
    key: "operating",
    rows: [
      { title: "Org brain — canonical doc structure", org: "Fresh", year: "2025–now", href: "/work/org-brain.html", note: "Consistent front-matter, machine-readable meaning" },
      { title: "AI community of practice", org: "Fresh", year: "2025–now", href: "/work/org-brain.html", note: "Ritual → operating model; engineering owns it" },
      { title: "Object model on the design system", org: "Fresh", year: "2025–now", href: "/work/org-brain.html", note: "Design as a shared practice, not an individual one" },
      { title: "Granola + Subframe in the SDLC", org: "Fresh", year: "2025–now", href: "/work/org-brain.html", note: "Research becomes queryable insight" },
      { title: "Global onboarding programme", org: "Reaktor", year: "2019–22", href: "/work/reaktor.html", note: "A shared baseline for how people work" },
      { title: "Talent growth rubrics", org: "Reaktor", year: "2019–22", href: "/work/reaktor.html", note: "Progression in language a person can act on" },
